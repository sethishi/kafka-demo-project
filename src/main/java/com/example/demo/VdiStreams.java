...
public class VdiStreams {
    ...
    public static void main(String[] args) {
        ...
        KTable<String, String> itemStream = builder.table(MMR_ITEM_REPO_TOPIC);
        KTable<String, String> contentSource = builder.table(MMR_CONTENT_REPO_TOPIC);
        KTable<String, String> scheduleSource = builder.table(MMR_SCHEDULE_REPO_TOPIC);
        ...
        finalTable.toStream().to(COMPACTED_OUTPUT_TOPIC, Produced.with(Serdes.String(), Serdes.String()));
